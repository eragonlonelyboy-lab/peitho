...
> **From npm:** `npm install -g demiurge-peitho`, then `peitho setup` Or without installing: `npx demiurge-peitho gate <copy.md>`. (Skill copy uses the source clone below.)
